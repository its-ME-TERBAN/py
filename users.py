...
TELEGRAM_BOT_TOKEN = '7700883024:AAHKn8pm_JnA514IEY6k0w1wv0PjWbdirsY'  # Replace with your bot token
ADMIN_USER_ID = 5820236233
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*❄️ WELCOME TO @@VIPDDOSSell38 ULTIMATE UDP FLOODER ❄️*\n\n"
...
async def attack(update: Update, context: CallbackContext):
    ...
    if user["coins"] < COINS_REQUIRED_PER_ATTACK:
        await context.bot.send_message(
            chat_id=chat_id,
            text="*💰 Bhai, tere paas toh coins nahi hai! Pehle admin ke paas ja aur coins le aa. 😂 DM:- @@VIPDDOSSell38*",
            parse_mode='Markdown'
        )
        return
...
async def help(update: Update, context: CallbackContext):
    chat_id = update.effective_chat.id
    message = (
        "*🛠️ @@VIPDDOSSell38 VIP DDOS Bot Help Menu 🛠️*\n\n"
        ...
        "- *Agar koi dikkat aaye toh admin ko contact karo: @@VIPDDOSSell38*\n\n"
